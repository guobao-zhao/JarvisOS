export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av JarvisOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av JarvisOS er lastet ned. Vil du installere den og starte på nytt?",
