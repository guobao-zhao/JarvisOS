export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'JarvisOS",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'JarvisOS a été téléchargée. Voulez-vous l'installer et redémarrer ?",
