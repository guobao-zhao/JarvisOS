export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af JarvisOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af JarvisOS er blevet downloadet. Vil du installere den og genstarte?",
