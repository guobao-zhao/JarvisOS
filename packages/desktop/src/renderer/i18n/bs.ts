export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju JarvisOS-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} JarvisOS-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
