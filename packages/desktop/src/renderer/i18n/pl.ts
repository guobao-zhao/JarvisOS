export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji JarvisOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} JarvisOS. Czy chcesz ją zainstalować i uruchomić ponownie?",
