export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de JarvisOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de JarvisOS. ¿Quieres instalarla y reiniciar?",
