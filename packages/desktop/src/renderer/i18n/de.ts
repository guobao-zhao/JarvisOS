export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von JarvisOS",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von JarvisOS wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
